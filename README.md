...
[![GitHub Super-Linter](https://github.com/DonBower/packer-vsphere-ubuntu-k8s/actions/workflows/code-quality.yml/badge.svg?style=for-the-badge)](https://github.com/marketplace/actions/super-linter)&nbsp;&nbsp;
![Issues](https://img.shields.io/github/issues/DonBower/packer-vsphere-ubuntu-k8s?style=for-the-badge)&nbsp;&nbsp;
![Last Commit](https://img.shields.io/github/last-commit/DonBower/packer-vsphere-ubuntu-k8s?style=for-the-badge&logo=github)&nbsp;&nbsp;
...
```console
TAG_NAME=$(curl -s https://api.github.com/repos/DonBower/packer-vsphere-ubuntu-k8s/releases | jq  -r '.[0].tag_name')
TARBALL_URL=$(curl -s https://api.github.com/repos/DonBower/packer-vsphere-ubuntu-k8s/releases | jq  -r '.[0].tarball_url')
...
git clone https://github.com/DonBower/packer-vsphere-ubuntu-k8s.git
cd packer-examples-for-vsphere
