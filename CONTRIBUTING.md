...
1. You [open a discussion](https://github.com/DonBower/packer-vsphere-ubuntu-k8s/discussions) to discuss any significant work with the maintainer(s).
...
```shell
git remote add upstream https://github.com/DonBower/packer-vsphere-ubuntu-k8s.git
...
discuss, [open a discussion](https://github.com/DonBower/packer-vsphere-ubuntu-k8s/discussions).
